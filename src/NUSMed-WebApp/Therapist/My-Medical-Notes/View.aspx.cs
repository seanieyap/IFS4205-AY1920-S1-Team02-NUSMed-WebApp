                ...
                try
                {
                    ...
                    else if (record.fileIsText)
                    {
                        ...
                        if (record.IsFileSafe())
                        {
                            ...
                            {
                                ScriptManager.RegisterStartupScript(this, GetType(), "Error Opening View File Modal", "toastr['error']('Text file is not formatted incorrectly to be plotted. To view file, please download it.'); $('#NoteRecords').collapse('show');", true);
                            }
                        }
                    }
