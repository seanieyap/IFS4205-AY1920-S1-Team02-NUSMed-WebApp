            ...
            <div class="col-12 col-md-6">
                <div class="card border-0">
                    <div class="card-body text-center text-md-left">
                        ...
                        <a href="~/Therapist/My-Patients/View" class="btn btn-nus-orange mb-2" runat="server">View <i class="fa fa-angle-double-right"></i></a>
                        <a href="~/Therapist/My-Patients/New-Request" class="btn btn-nus-orange mb-2" runat="server">New Request <i class="fa fa-angle-double-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="card border-0">
                    <div class="card-body text-center text-md-left">
                        ...
                        <a href="~/Therapist/My-Medical-Notes/View" class="btn btn-nus-orange mb-2" runat="server">View <i class="fa fa-angle-double-right"></i></a>
                        <a href="~/Therapist/My-Medical-Notes/New-Medical-Note" class="btn btn-nus-orange mb-2" runat="server">New Medical Note <i class="fa fa-angle-double-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
