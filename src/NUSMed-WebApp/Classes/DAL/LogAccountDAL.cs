...
{
    public class LogAccountDAL : DALLog
    {
        /// <summary>
        /// Insert Account Log Event
        /// </summary>
        ...
        /// </summary>
        public void InsertRecord(string creatorNRIC, string action, string description)
        {
            using (MySqlCommand cmd = new MySqlCommand())
            {
        ...
        /// </summary>
        public void InsertPermission(string creatorNRIC, string action, string description)
        {
            using (MySqlCommand cmd = new MySqlCommand())
            {
