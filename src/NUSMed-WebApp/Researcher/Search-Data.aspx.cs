  ...
  public partial class Search_Data : Page
  {
    ...
    protected void ButtonDownload_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        {
          Response.Write(anonPatientsTable.Columns[i].ColumnName);
          Response.Write((i < anonPatientsTable.Columns.Count - 1) ? delimiter : Environment.NewLine);
        }
        ...
        //MemoryStream mm = GetStream(anonPatientsTable);
        //Response.Clear();
        //Response.ContentType = "text/csv";
        //Response.AddHeader("content-disposition", "attachment; data_anon.csv;");
