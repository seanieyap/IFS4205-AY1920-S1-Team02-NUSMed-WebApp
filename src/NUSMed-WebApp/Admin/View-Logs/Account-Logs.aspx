<%@ Page Title="Account Logs" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Account-Logs.aspx.cs" Inherits="NUSMed_WebApp.Admin.View_Logs.Account_Logs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="container">
        <div class="py-5 mx-auto text-center">
            <h1 class="display-4"><i class="fas fa-fw fa-database"></i>Account Logs</h1>
