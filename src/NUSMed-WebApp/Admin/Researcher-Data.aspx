...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel" class="container" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="row">
                <div class="col-12">
                    <asp:LinkButton ID="LinkbuttonDataGenerate" CssClass="btn btn-success" runat="server" Visible="false" OnClick="LinkbuttonDataGenerate_Click"><i class="fas fa-fw fa-redo"></i>Re-Generate Data</asp:LinkButton>
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
    <asp:UpdateProgress runat="server" AssociatedUpdatePanelID="UpdatePanel" DisplayAfter="0" DynamicLayout="false">
        <ProgressTemplate>
